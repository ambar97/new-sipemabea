...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="{{ asset('Appland/assets/css/logoanim.css') }}" rel="stylesheet">
    ...
    <header id="header" class="fixed-top  header-transparent ">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo mr-auto">
                <a href="{{ asset('/') }}"><img src="" alt="" class="img-fluid"> SIPEMABEA</a>
            </div>

            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    <li><a href="{{ asset('/#alur') }}"> <i class="fa fa-gallery"></i> ALUR PENGAJUAN</a></li>
                    <li><a href="{{ asset('/#pedoman') }}"> <i class="fa fa-gallery"></i> PEDOMAN PEMBELAJARAN</a>
                    </li>
                    <li><a href="{{ asset('/#kegiatan') }}"> <i class="fa fa-gallery"></i> GALERI</a></li>
                    <li><a href="{{ asset('/#sahabat') }}"> <i class="fa fa-gallery"></i> DAFTAR SAHABAT</a></li>
                    <li><a href="{{ asset('/#footer') }}"> <i class="fa fa-gallery"></i> TRACKING PENGAJUAN</a></li>
                    <li class="get-started"><a href="{{ asset('daftar') }}"> <i class="fa fa-pencil"></i> DAFTAR
                            MAGANG</a></li>
                </ul>
            </nav><!-- .nav-menu -->
