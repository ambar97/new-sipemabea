...
class DaftarController extends Controller
{
    ...
    public function insertData(Request $req)
    {
        $validatedData = $req->validate([
            ...
            'peserta.*' => 'Nama Peserta Tidak boleh kosong',
            'peserta' => 'Nama Peserta Tidak boleh kosong',
            'peserta.array' => 'Nama Peserta Tidak boleh kosong',
            'pernyataan' => 'Harap centang / setujui Pernyatan Magang',
            'tujuan.required' => 'Tujuan magang tidak boleh kosong.',
            'tujuan.max' => 'Tidak boleh lebih dari 50 kata.',
            'email.required' => 'Mail harus diisi untuk pemberitahuan lebih lanjut.',
            'email.email' => 'Mail harus Lengkap Contoh @gmail.com',
            'jurusan.required' => 'Asal Jurusan harus diisi',
            'notelp.required' => 'Nomor telepon harus diisi untuk pemberitahuan lebih lanjut.',
            'notelp.max' => 'Nomor telepon tidak boleh lebih dari 12 / 13 angka.',
            'instansi.required' => 'Asal Kampus / sekolah harus diisi.',
            'berkas.required' => 'Proposal Pengajuan peserta harus diunggah.',
            'berkas.mimes' => 'File Proposal harus berupa PDF.',
            'berkas.max' => 'Ukuran file Proposal tidak boleh lebih dari 2MB.',
            'no_surat.required' => 'Nomor Surat harus diisi.',
            'ceve.required' => 'File CV peserta harus diunggah.',
            'ceve.mimes' => 'File CV harus berupa PDF.',
            'ceve.max' => 'Ukuran File CV peserta tidak boleh lebih dari 2MB.',
        ]);
